...
{
    [Tooltip("地面巡逻路径点列表（世界坐标）。怪物将按顺序在这些点之间往返巡逻。")]
    public List<Vector2> patrolPoints = new List<Vector2>();
    [Tooltip("巡逻路径往返：true 则在路径点之间来回往返，false 则到末尾后循环回到第一个点。")]
    ...
    [Tooltip("巡逻模式组合整体是否循环（false则各模式执行一次后巡逻阶段结束）")]
